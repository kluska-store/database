...
-- FOREIGN KEYS
ALTER TABLE "store"
    ADD CONSTRAINT "fk_store_address_id__address_id"
        FOREIGN KEY ("address_id") REFERENCES "address" ("id")
            ON DELETE SET NULL;

ALTER TABLE "store_session"
    ADD CONSTRAINT "fk_store_session_store_id__store_id"
        FOREIGN KEY ("store_id") REFERENCES "store" ("id")
            ON DELETE CASCADE;

ALTER TABLE "store_phones"
    ADD CONSTRAINT "fk_store_phones_store_id__store_id"
        FOREIGN KEY ("store_id") REFERENCES "store" ("id")
            ON DELETE CASCADE;

ALTER TABLE "user"
    ADD CONSTRAINT "fk_user_address_id__address_id"
        FOREIGN KEY ("address_id") REFERENCES "address" ("id")
            ON DELETE SET NULL;

ALTER TABLE "user_session"
    ADD CONSTRAINT "fk_user_session_user_id__user_id"
        FOREIGN KEY ("user_id") REFERENCES "user" ("id")
            ON DELETE CASCADE;

ALTER TABLE "product"
    ADD CONSTRAINT "fk_product_store_id__store_id"
        FOREIGN KEY ("store_id") REFERENCES "store" ("id")
            ON DELETE CASCADE;

ALTER TABLE "wish_list"
    ADD CONSTRAINT "fk_wish_list_user_id__user_id"
        FOREIGN KEY ("user_id") REFERENCES "user" ("id")
            ON DELETE CASCADE;

ALTER TABLE "cart"
    ADD CONSTRAINT "fk_cart_user_id__user_id"
        FOREIGN KEY ("user_id") REFERENCES "user" ("id")
            ON DELETE CASCADE;
